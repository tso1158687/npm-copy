var RegClient, _, fibrous, fs, path, indexOf = [].indexOf ||
    function (item) {
...
module.exports = fibrous(function (argv) {
    var dir, dist, e, from, fromVersions, i, k, len, moduleName, moduleNames, newMetadata, npm, oldMetadata, publishUrl, ref, ref1, remoteTarball, res, results, semver, to, toVersions, v, versionsToSync;
    (ref = (function () {
    ...
    for (i = 0, len = ref1.length; i < len; i++) {
        ...
        results.push((function () {
            ...
            for (semver in fromVersions) {
                ...
                try {
                    var publishUrl_1 = to.host === "verdaccio" ? to.url : to.url + "/moduleName";
                    res = npm.sync.publish(publishUrl_1, {
                        auth: to.auth,
                    ...
                    results1.push(console.warn(moduleName +
                        "@" +
                        semver +
